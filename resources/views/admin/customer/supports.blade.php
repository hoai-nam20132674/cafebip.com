...
<div id="page-wrapper">
	<div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Hỗ trợ trực tuyến</h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
                    ...
                    <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-customer">
                        ...
                        <tbody>
                            ...
                            <tr class="odd gradeX">
                                ...
                                <img @if($cus->idloginsocial==null) src="{{ asset('img/customers/'.$cus->cusimg) }}" @else src="{{ $cus->cusimg }}" @endif style="width: 55px">
                                </td>                                        
                                <td>
            ...
            <div class="row">
                ...
                <div class="col-xs-6">
                    <div class="form-group" style="display: none;">                        
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="type" id="type" value="sp">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <select class="form-control" name="nngroupkh">
                                <option value="2">Hỗ trợ trực tuyến</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
