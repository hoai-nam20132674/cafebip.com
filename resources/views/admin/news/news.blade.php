                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        ...
                        <div class="col-sx-12 col-md-12">
                          <textarea name="nnkeywords" class="form-control" rows="4">{!! old('nnkeywords') !!}</textarea>
                        </div>
                    </div>
                    <div class="form-group">
                ...
                @endif
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                            ...
                            <div class="col-xs-12 col-md-12">
                              <textarea name="ennkeywords" class="form-control" rows="4" id="ennkeywords">{!! old('ennkeywords') !!}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
