...
<head>
    ...
    <link href="bootstrap/selector/css/select2.min.css" rel="stylesheet"> 
    ...
    <script src="<?php echo e(url('editor/func_ckfinder.js"></script>
    <!-- endckeditor -->
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top navbar-fixed-top" role="navigation" style="margin-bottom: 0 ;">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="/admin">Tin tức mới | Admin</a>
            </div>
            <!-- /.navbar-header -->
                    ...
                    <ul class="dropdown-menu dropdown-alerts">
                        ...
                        <li>
                            <div class="col-xs-12 nn_select_lang" name="nnlocation" idlang="{{$lang->id); ?>">
                                ...
                                <img src="img/lang/'.$lang->img)}}" class="img-thumnail nn-img-lang-top">
                            </div>
                            <hr>
                        </li>
                        <li class="divider"></li>
                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="<?php echo url('/admin/modnews/list'); ?>"><i class="fa fa-retweet fa-fw"></i> {{trans('translate.modNews</a>
                                </li>                                
                                <li>
                                    <a href="<?php echo url('/admin/listnews/list'); ?>"><i class="fa fa-bars fa-fw"></i> {{trans('translate.cateNews</a>
                                </li>
                                <li>
                                    <a href="<?php echo url('/admin/news/list'); ?>"><i class="fa fa-newspaper-o fa-fw"></i> {{trans('translate.News</a>
                                </li>
                            </ul>  
                        </li>                           
                        <li>
...
<div class="modal fade nn-modal-change-pass" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
    ...
    <script src="bootstrap/selector/js/select2.min.js"></script>
    <script src="bootstrap/selector/js/select2.js"></script>
