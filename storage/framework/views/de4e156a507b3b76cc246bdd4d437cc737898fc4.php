...
<head>
    ...
    <link href="<?php echo e(asset('bootstrap/metisMenu/metisMenu.min.css')); ?>" rel="stylesheet">  
        <!-- DataTables CSS -->
    <link href="<?php echo e(asset('bootstrap/datatables-plugins/dataTables.bootstrap.css')); ?>" rel="stylesheet">

    <!-- DataTables Responsive CSS -->
    <link href="<?php echo e(asset('bootstrap/datatables-responsive/dataTables.responsive.css')); ?>" rel="stylesheet"> 
    <link href="<?php echo e(asset('bootstrap/selector/css/select2.min.css')); ?>" rel="stylesheet"> 
    <link href="<?php echo e(asset('bootstrap/css/sb-admin-2.css')); ?>" rel="stylesheet"> 
    <link href="<?php echo e(asset('css/page.css')); ?>" rel="stylesheet"> 
    <link href="<?php echo e(asset('bootstrap/css/font-awesome.css')); ?>" rel="stylesheet"> 
    <script src="<?php echo e(asset('bootstrap/js/jquery.js')); ?>"></script>

    <!-- ckeditor -->
    <script src="<?php echo e(asset('editor/ckeditor/ckeditor.js')); ?>"></script>
    <script src="<?php echo e(asset('editor/ckfinder/ckfinder.js')); ?>"></script>
    <script type="text/javascript">
        var baseURL="<?php echo url('/'); ?>";        
    </script>
    <script src="<?php echo e(asset('editor/func_ckfinder.js')); ?>"></script>
    <!-- endckeditor -->
                    ...
                    <ul class="dropdown-menu dropdown-alerts">
                        ...
                        <li>
                            <div class="col-xs-12 nn_select_lang" name="nnlocation" idlang="<?php echo e($lang->id); ?>">
                                ...
                                <img src="<?php echo e(asset('img/lang/'.$lang->img)); ?>" class="img-thumnail nn-img-lang-top">
                            </div>
                            <hr>
                        </li>
                        <li class="divider"></li>
...
<div class="modal fade nn-modal-change-pass" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
    ...
    <script src="<?php echo e(asset('bootstrap/metisMenu/metisMenu.min.js')); ?>"></script>
    <script src="<?php echo e(asset('bootstrap/datatables/js/jquery.dataTables.min.js')); ?>"></script>
    <script src="<?php echo e(asset('bootstrap/datatables-plugins/dataTables.bootstrap.min.js')); ?>"></script>
    <script src="<?php echo e(asset('bootstrap/datatables-responsive/dataTables.responsive.js')); ?>"></script>
    <script src="<?php echo e(asset('bootstrap/selector/js/select2.min.js')); ?>"></script>
    <script src="<?php echo e(asset('bootstrap/selector/js/select2.js')); ?>"></script>
    <script src="<?php echo e(asset('bootstrap/js/sb-admin-2.js')); ?>"></script>
